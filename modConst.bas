...
Public Const NAME_OUTLOOK_SENDER_EMAIL As String = "OUTLOOK_SENDER_EMAIL"
...
Public Const NAME_CREATE_EMAIL_DRAFT As String = "CREATE_EMAIL_DRAFT"
Public Const NAME_MAIL_SUBJECT As String = "MAIL_SUBJECT"
Public Const NAME_MAIL_BODY As String = "MAIL_BODY"
Public Const NAME_MAIL_BODY_NO_TEAMS As String = "MAIL_BODY_NO_TEAMS"
Public Const NAME_MAIL_TO As String = "MAIL_TO"
Public Const NAME_MAIL_CC As String = "MAIL_CC"
Public Const NAME_MAIL_FROM As String = "MAIL_FROM"
Public Const NAME_MAIL_SHAREPOINT_URL As String = "MAIL_SHAREPOINT_URL"
...
Public Const ERROR_EMAIL As Long = 1901
